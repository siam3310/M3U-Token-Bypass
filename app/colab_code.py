...
try:
    ...
    logging.exception(f"Error importing google.colab: {e}")
    IN_COLAB = False
    print("Not running in Google Colab. Automatic download will be skipped.")
...
async def main():
    ...
    async with aiohttp.ClientSession(headers=headers, timeout=timeout) as session:
        ...
        with open(filename, "w", encoding="utf-8") as f:
            f.write("""#EXTM3U
""")
            f.write(f"# Generated by Colab Scraper at {time.ctime()}\n\n")
        ...
        if IN_COLAB:
            ...
            try:
                ...
                logging.exception(f"Error triggering download: {e}")
